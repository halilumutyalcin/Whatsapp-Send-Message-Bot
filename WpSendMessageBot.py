...
search.click()
search.send_keys("NAME") # enter full contact name
time.sleep(5)
choose = browser.find_element_by_xpath("/html/body/div[1]/div/div/div[3]/div/div[2]/div[1]/div/div/div[10]/div/div/div[2]")
choose.click()
time.sleep(5)
...
for i in range(10): # enter num of times in range for how many send you want
    msgbar.send_keys("MESSAGE") # enter first message
    send = browser.find_element_by_xpath("/html/body/div[1]/div/div/div[4]/div/footer/div[1]/div[3]")
    send.click()
